  ...
  export default {
    ...
    methods: {
      ...
      searchState (index) {
        ...
        if (this.searchData.length > 0) {
          ...
          if (this.searchData.length == 24) {
            ...
            _this.hoursList = this.searchData
            var item = {
              num: _this.hoursList[0].num
            }
            _this.getOneHourLog(_this.hoursList[0].num, item)
      ...
      getAllState () {
        ...
        this.hoursList = this.searchData
        this.hourActive = new Date().getHours()
        this.hour = 100
        var item = {
          num: new Date().getHours()
        }
        this.getOneHourLog(this.hoursList[0].num, item)
...
<style scoped>
  ...
  .scroll-view_H .hoursList>li:last-child {
    width: 150rpx;
    height: 100rpx;
    position: relative;
  }
  .scroll-view_H .hoursList>li:last-child  span{
    position: absolute;
    left: 28rpx;
    top: 20rpx;
  }
  .scroll-view_H .hoursList>li:last-child .pointsList{
    text-align: left;
    text-indent: 18rpx;
  }
  .hour_line_detail{
