<template>
    <div class="page">
      <div class="weui-cells ">
          <div class="weui-cell" v-for="(item,index) in personon" :key="item.uid" @click="personInfoOn(index)">
      ...
      <div class="weui-cells">
        <div class="weui-cell" v-for="(item,index) in personoff" :key="item.uid" @click="personInfoOff(index)">
          <div class="weui-cell__hd">
