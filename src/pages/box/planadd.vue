  ...
  <div class="page">
    ...
    <div class="weui-cells">
      <div class="weui-cell weui-cell_input">
        ...
        <div class="weui-cell__bd">
          <picker mode="time" value="time" @change="bindEndTimeChange">
  ...
  export default {
    ...
    methods: {
      ...
      submitplan () {
        ...
        console.log(this.plan.starttime)
        console.log(this.plan.endtime)
        console.log(this.plan.endtime < this.plan.starttime)
        if (this.plan.endtime <= this.plan.starttime) {
          $Toast({
            content: '结束时间应迟于开始时间',
            type: 'warning',
            duration: 3
