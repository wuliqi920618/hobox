module.exports = [
  ...
  {
    path: '/pages/box/guide',
    config: {
      navigationBarTitleText: '新手指导'
    }
  },
  {
    path: '/pages/box/bindSuccess',
    config: {
      navigationBarTitleText: '绑定成功'
    }
  },
  {
    path: '/pages/box/bindFail',
    config: {
      navigationBarTitleText: '绑定失败'
    }
  },
  {
    path: '/pages/box/addperson',
    config: {
  ...
  {
    path: '/pages/box/devlist',
    config: {
      navigationBarTitleText: '设备列表'
    }
  },
  {
    path: '/pages/box/personselect',
    config: {
      navigationBarTitleText: '人员列表',
      usingComponents: {
        'i-avatar': '/static/iView/avatar/index'
